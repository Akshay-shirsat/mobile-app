<template>
  <div>
   ...
   <div class="rounded-box q-pt-sm q-pa-md q-gutter-md">
      <q-list bordered padding class="rounded-borders" style="max-width: 350px">
        <q-item clickable v-ripple>
          <div class="vertical-separator"></div>

          <q-item-section>
            <q-item-label class="text-left text-weight-medium">Pending</q-item-label>
...
.vertical-separator {
  width: 1px;
  height: 100%;
  background-color: rgb(15, 14, 14); /* Set the desired color for the separator */
  margin-right: 10px;
}
.q-pt-sm {
